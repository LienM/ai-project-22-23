...
class BatchProcess:
    ...
    def __init__(self, modulename):
        ...
        self.check_column = None                # check values of column (index 0: name, index 1 and further: values)
    ...
    def join_files(self, base_filename):
        ...
        assert sorted(complete_frame[self.check_column[0]].values.tolist()) == sorted(self.check_column[1:])
