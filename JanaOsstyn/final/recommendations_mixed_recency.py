...
class RecencyMixedRecommender(BatchProcess):
    ...
    def __init__(self, args):
        ...
        self.check_column = ['customer_id'] + self.customers_transactions_df['customer_id'].values.tolist()
    ...
    def batch_function(self, min_row_ind, batch_nr):
        ...
        assert set((part_of_df['prediction'].str.count('\s') + 1).values.tolist()) == {12}
...
if __name__ == '__main__':
    # e.g. python recommendations_mixed_recency.py --similarity_version similarities_ResNet50_W128_H128
