...
class RecencyPairwiseRecommender(BatchProcess):
    ...
    def __init__(self, args):
        ...
        self.check_column = ['customer_id'] + self.customer_transaction_df['customer_id'].values.tolist()
    ...
    def batch_function(self, min_row_ind, batch_nr):
        ...
        assert False not in [pred[1].count('\s') + 1 == 12 for pred in prediction]
...
if __name__ == '__main__':
    # e.g. python recommendations_pairwise_recency.py --similarity_version similarities_ResNet50_W128_H128
    #      --nr_rows_per_batch 10000 --sim_level 1
