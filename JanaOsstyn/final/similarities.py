...
class SimilarityCalculator(BatchProcess):
    ...
    def __init__(self, args):
        ...
        self.check_column = ['article_id'] + article_df['article_id'].values.tolist()
    ...
    def batch_function(self, min_row_ind, batch_nr):
        ...
        assert similarity_idx_df.shape[1] == similarity_value_df.shape[1] == self.keep_nr
        assert similarity_idx_df.shape[0] == similarity_value_df.shape[0] == part_of_embed_df.shape[0]
        ...
        assert similarity_ids_df.shape[1] == self.keep_nr
        assert similarity_ids_df.shape[0] == part_of_embed_df.shape[0]
...
if __name__ == '__main__':
    # e.g. python similarities.py --embedding_version embeddings_ResNet50_W128_H128 --nr_rows_per_batch 2000
