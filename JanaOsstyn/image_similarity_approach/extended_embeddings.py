...
class ExtendedEmbeddingCalculator(BatchProcess):
    ...
    def run(self):
        ...
        This method overwrites the method self.run of the superclass as execution is not entirely as the self.run of
        the superclass.
        """
        if not self.can_run():
    ...
    def concat_with_image_embeddings(self):
        ...
        for directory in content:
            ...
            img_embedding_df = pd.concat([img_embedding_df, embedding_df], axis=1)
